export const studioLocationString = 
...
export const locationInputString = 
...
import { fetchAutocompleteSuggestions, fetchPlaceDetails } from "../../googleAPIFunctions";
...
export const useClickOutsideString = 
